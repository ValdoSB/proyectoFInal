...
<body>
    <main>
        ...
        <form action="{{ route('usuarios.update',$usuario->id)}}" method="post" id="createUserForm">
            @method('PATCH')
            @csrf
            <fieldset>
                <legend>CURP</legend>
            ...
            <fieldset>
                ...
                <input 
                    ...
                    value="{{$usuario->clientPostalCode}}"
